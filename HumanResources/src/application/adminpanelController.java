...
public class adminpanelController {
    ...
    @FXML
    private ImageView taleplistesi;

    @FXML
    private ImageView uyeler;
    ...
    void taleplistesi_Click(MouseEvent event) {
    	try {
    		Stage stage=new Stage();
        	AnchorPane paneadmin=(AnchorPane) FXMLLoader.load(getClass().getResource("talep.fxml"));
        	Scene scene1=new Scene(paneadmin,555,380);
        	stage.setScene(scene1);
        	stage.show();
    ...
    void uyeler_Click(MouseEvent event) {
    	try {
    		Stage stage=new Stage();
        	AnchorPane paneadmin=(AnchorPane) FXMLLoader.load(getClass().getResource("uyeler.fxml"));
        	Scene scene1=new Scene(paneadmin,1140,655);
        	stage.setScene(scene1);
        	stage.show();
