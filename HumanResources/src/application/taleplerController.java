...
public taleplerController() {
    ...
    void reddet_izinClick(ActionEvent event) {
    	guncelle("update tbl_izin set onaydurumu=? where id=?","REDDEDÝLDÝ");
    	onaydurumu2.setText("REDDEDÝLDÝ");
    }

    @FXML
    void reddet_primClick(ActionEvent event) {
    	guncelle("update tbl_prim set onaydurumu=? where id=?","REDDEDÝLDÝ");
    	onaydurumu.setText("REDDEDÝLDÝ");
